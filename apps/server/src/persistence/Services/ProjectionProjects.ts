 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@codewithme/contracts";
...
>()("codewithme/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
