...
import { GitCommandError } from "@codewithme/contracts";
import { GitCore } from "../../git/Services/GitCore.ts";
import { CheckpointStore, type CheckpointStoreShape } from "../Services/CheckpointStore.ts";
import { CheckpointRef } from "@codewithme/contracts";
...
const makeCheckpointStore = Effect.gen(function* () {
  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = Effect.fn(
    ...
    yield* Effect.acquireUseRelease(
      fs.makeTempDirectory({ prefix: "codewithme-fs-checkpoint-" }),
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "CodeWithMe",
          GIT_AUTHOR_EMAIL: "codewithme@users.noreply.github.com",
          GIT_COMMITTER_NAME: "CodeWithMe",
          GIT_COMMITTER_EMAIL: "codewithme@users.noreply.github.com",
        };
        ...
        const message = `codewithme checkpoint ref=${input.checkpointRef}`;
