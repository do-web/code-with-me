...
export interface WsRpcClient {
  ...
  readonly projects: {
    ...
    readonly readPackageScripts: RpcUnaryMethod<typeof WS_METHODS.projectsReadPackageScripts>;
...
export function createWsRpcClient(transport = new WsTransport()): WsRpcClient {
  return {
    ...
    projects: {
      ...
      readPackageScripts: (input) =>
        transport.request((client) => client[WS_METHODS.projectsReadPackageScripts](input)),
      listDirectory: (input) =>
