...
import { GitCommandError, type GitBranch } from "@codewithme/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@codewithme/shared/git";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `codewithme-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
